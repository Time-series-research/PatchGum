...
from exp.exp_new_energy_forecasting import Exp_New_Energy_Forecast
...
parser.add_argument('--root_path', type=str, default='./data/ETTm1', help='root path of the data file')
...
# parser.add_argument('--d_model', type=int, default=16, help='TimesNEt dimension of model, 512')
parser.add_argument('--d_model', type=int, default=512, help='dimension of model, 512')
parser.add_argument('--n_heads', type=int, default=8, help='num of heads')
parser.add_argument('--e_layers', type=int, default=2, help='num of encoder layers')
parser.add_argument('--d_layers', type=int, default=1, help='num of decoder layers')
# parser.add_argument('--d_ff', type=int, default=32, help='dimension of fcn, 32')
...
if args.task_name == 'new_energy' and args.model == 'Windformer':
    ...
    spectral, category = series.train_fit()
